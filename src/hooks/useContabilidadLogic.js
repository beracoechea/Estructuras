...
                        // MODIFICACIÓN: Inicializar comentarios anuales
                        newItem.comentariosAnuales = { [currentYearForDefaults]: "" };
...
            };
            
            // MODIFICACIÓN: Inicializar comentarios si el item custom es mensual
            if (itemCompleto.frecuencia === 'mensual') {
                if (!itemCompleto.cumplimientoMensual) {
                    itemCompleto.cumplimientoMensual = { [currentYearForDefaults]: Array(12).fill(false) };
                }
                if (!itemCompleto.comentariosAnuales) {
                    itemCompleto.comentariosAnuales = { [currentYearForDefaults]: "" };
                }
...
                    // La fecha de actualización se sobreescribe aquí
                }
                return item;
            });
        });
